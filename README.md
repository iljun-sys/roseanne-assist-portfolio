...
<img src="screenshots/doctor-01-briefing.png" alt="원장 진료실 — 배정된 환자 목록과 환자 브리핑" />

- 왼쪽은 **나에게 배정된 환자**(미배정·대기중·진료중·완료), 오른쪽은 고른 환자의 브리핑
- 환자별 **진료 메모**(자동 저장)와 **음성 녹음** — 녹음은 전사 후 요약해 기록 부담을 줄임
- **즉시 확인 필요**(복용약·기저질환)를 맨 위에 두고, 갱년기 환자는 **KI 점수**와 상위 증상을 함께 표시

#### AI 브리핑

<img src="screenshots/doctor-02-ai-briefing.png" alt="AI 브리핑 — 문진표 원본 옆의 증상 요약과 감별진단 힌트" />

- 문진 내용을 **증상 요약 · 감별진단 힌트 · 추가 문진 추천**으로 정리
- **문진표 원본 바로 옆**에 두어 AI 요약을 원자료와 대조하며 볼 수 있음
- 같은 날 생성한 결과는 저장해 다시 열 때 재호출하지 않음

#### 환자 안내문

<img src="screenshots/doctor-05-handout.png" alt="환자 안내문 — AI 초안 편집과 인쇄 미리보기" />
...
<img src="screenshots/doctor-06-overview.png" alt="전체 현황 — 원장별 환자 배치" />
